...
pub fn wn_pnpoly(point: &Point, vectors: &[Vector]) -> u32 {
...
/// Get point y coordinate from the given line (point_0, point_1)
...
/// Get point x coordinate from the given line (point_0, point_1)
